...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_email_error_message" value='<?php echo (!empty($wpemp_settings['wpemp_email_error_message'])) ? $wpemp_settings['wpemp_email_error_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_account_activated_message" value='<?php echo (!empty($wpemp_settings['wpemp_account_activated_message'])) ? $wpemp_settings['wpemp_account_activated_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_account_notactivated_message" value='<?php echo (!empty($wpemp_settings['wpemp_account_notactivated_message'])) ? $wpemp_settings['wpemp_account_notactivated_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_login_success_message" value='<?php echo (!empty($wpemp_settings['wpemp_login_success_message'])) ? $wpemp_settings['wpemp_login_success_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_login_error_message" value='<?php echo (!empty($wpemp_settings['wpemp_login_error_message'])) ? $wpemp_settings['wpemp_login_error_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_password_reset_link_sent_message" value='<?php echo (!empty($wpemp_settings['wpemp_password_reset_link_sent_message'])) ? $wpemp_settings['wpemp_password_reset_link_sent_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_password_reset_link_notsent_message" value='<?php echo (!empty($wpemp_settings['wpemp_password_reset_link_notsent_message'])) ? $wpemp_settings['wpemp_password_reset_link_notsent_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_password_reset_invalid_email_message" value='<?php echo (!empty($wpemp_settings['wpemp_password_reset_invalid_email_message'])) ? $wpemp_settings['wpemp_password_reset_invalid_email_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_password_reset_success_message" value='<?php echo (!empty($wpemp_settings['wpemp_password_reset_success_message'])) ? $wpemp_settings['wpemp_password_reset_success_message'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        <input type="text" name="wpemp_invalid_password_reset_token_message" value='<?php echo (!empty($wpemp_settings['wpemp_invalid_password_reset_token_message'])) ? $wpemp_settings['wpemp_invalid_password_reset_token_message'] : ''; ?>' class='wide' />
