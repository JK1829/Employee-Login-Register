                ...
                <form method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>">
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <input  type="checkbox" name="wpemp_user_email_confirmation" value= '1' class='wide' <?php echo (!empty($wpemp_settings['wpemp_user_email_confirmation']) && $wpemp_settings['wpemp_user_email_confirmation'] == '1' ) ? 'checked="checked"' : ''; ?> />
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <?php
                                if (empty($wpemp_settings['wpemp_notification_subject'])) {
                                    $wpemp_settings['wpemp_notification_subject'] = __('Welcome to %BLOGNAME%', $this->plugin_name);
                                }
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <?php
                                if (empty($wpemp_settings['wpemp_notification_message'])) {

                                    $wpemp_settings['wpemp_notification_message'] = __(
...
The team at %BLOGNAME%'
                    ...
                    <div>
                        <input type="hidden" name="wpempsubmitted" value="1" />
                        <input type="hidden" name="_nonce" value="<?php echo wp_create_nonce('wpemp-admin' . get_current_user_id()); ?>" />
                        <p class="submit">
